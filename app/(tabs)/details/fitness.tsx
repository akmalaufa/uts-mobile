    ...
    return (
      <View style={{ backgroundColor: "#808836", width: "100%", height: "100%" }}>
        <View style={{ marginTop: 45, marginLeft: 20 }}>
          ...
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>Menjaga</Text>
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>Kebugaran</Text>
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>Tubuh</Text>
        </View>
